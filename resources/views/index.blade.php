...
@section('contenu')
            ...
            <article> 
                ...
                <section class="banner mask-overlay pad-120 white-clr">
                    <div class="container theme-container rel-div">
                        ...
                        <ul class="list-items fw-600 effect animated wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s">   
                            ...
                            <li><a href="#">à l'échelle mondiale</a></li>
                        </ul>
                        <h2 class="section-title fs-48 effect animated wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s"> MODÈLE IMPRESSIONNANT POUR <br> <span class="theme-clr">  COURRIER </span> & <span class="theme-clr"> SERVICE DE </span> LIVRAISON </h2>
                    </div>
                ...
                <section class="pad-80 about-wrap clrbg-before">
                    <span class="bg-text wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s"> À propos de nous </span>
                    <div class="theme-container container">               
                        <div class="row">
                            <div class="col-md-6">
                                <div class="about-us">
                                    <h2 class="section-title pb-10 wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s"> À propos de nous </h2>
                                    ...
                                    <ul class="feature">
                                        <li> 
                                            ...
                                            <div class="feature-content wow rotateInDownRight" data-wow-offset="50" data-wow-delay=".30s"> 
                                                <h2 class="title-1">LIVRAISON RAPIDE </h2> 
                                        ...
                                        <li> 
                                            ...
                                            <div class="feature-content wow rotateInDownRight" data-wow-offset="50" data-wow-delay=".30s"> 
                                                <h2 class="title-1">Service sécurisé </h2> 
                                        ...
                                        <li> 
                                            ...
                                            <div class="feature-content wow rotateInDownRight" data-wow-offset="50" data-wow-delay=".30s"> 
                                                <h2 class="title-1">livraison internationale</h2> 
                            ...
                            <div class="col-md-6 text-center">
                                ...
                                <img alt="" src="img/about-img.png" class="wow slideInRight" data-wow-offset="50" data-wow-delay=".20s" />
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-8">
                                <div class="title-wrap">
                                    <h2 class="section-title wow fadeInLeft" data-wow-offset="50" data-wow-delay=".20s">contactez nous</h2>
                                    
                                </div>
                                <ul class="contact-detail title-2">
                                    
                                    <li class="wow slideInUp" data-wow-offset="50" data-wow-delay=".25s"> <span>Tel:</span> <p class="gray-clr"> +216-99-999-999 <br> +216-99-999-999 </p> </li>
                                    <li class="wow slideInUp" data-wow-offset="50" data-wow-delay=".30s"> <span>Adresse email:</span> <p class="gray-clr"> molkaDelivrey@gmail.com <br> molkaDelivrey@gmail.com </p> </li>
                                </ul>
                            </div>                        
                        </div>
                    </div>               
