                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <form action="/editColisP" method="post">
                                            @csrf 
                                                ...
                                                <div>
                                                    <div class="mb-3">
                                                     ...
                                                     <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" value="{{$donnee['qte']}}" name="qte" placeholder="quantité" id="example-text-input">
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="email" name="email" value="{{$donnee['email']}}" placeholder="nom@example.com" id="example-email-input">
                                                    </div>
