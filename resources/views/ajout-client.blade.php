                                            ...
                                            <div class="col-lg-12">
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" name="name" placeholder="nom" id="example-text-input">
                                                    </div>

                                                     <div class="mb-3">
                                                        <label for="example-number-input" class="form-label">raison sociale</label>
                                                        <input class="form-control" type="number" name="raison_sociale" placeholder="raison sociale" id="example-number-input">
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                     ...
                                                     <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="number" name="matricule_fiscale" placeholder="matricule fiscale" id="example-number-input">
                                                    </div>

                                                      <div class="mb-3">
                                                        <label for="example-tel-input" class="form-label">Telephone</label>
                                                        <input class="form-control" type="text" name="tel" placeholder="tel" id="example-tel-input">
                                                    </div>

                                                   
                                                    <div class="mb-3">
                                                        <label for="example-email-input" class="form-label">Email</label>
                                                        <input class="form-control" type="email" name="email" placeholder="client@example.com" id="example-email-input">
                                                    </div>
